...
// 			console.log($(this).val());
			...
			location.href="list.jsp?perPage=" + perPage;
		})
	});
</script>
</head>
<body>
	...
	<select id="perPage">
		<option value="5"
		<%
			if(perPage == 5) out.print("selected");
		%>
		> 5줄씩 보기</option>
		<option value="10"
		<%
			if(perPage == 10) out.print("selected");
		%>
		> 10줄씩 보기</option>
		<option value="15"
		<%
			if(perPage == 15) out.print("selected");
		%>
		> 15줄씩 보기</option>
		<option value="20"
		<%
			if(perPage == 20) out.print("selected");
		%>
		> 20줄씩 보기</option>
	</select>
